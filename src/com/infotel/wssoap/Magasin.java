...
public class Magasin  implements java.io.Serializable {
    ...
    private com.infotel.wssoap.Produit[] produits;
    ...
    public Magasin(
           ...
           int codeMagasin,
           double prixDuLocal,
           com.infotel.wssoap.Produit[] produits) {
    ...
    /**
     * Gets the produits value for this Magasin.
     * 
     * @return produits
     */
    public com.infotel.wssoap.Produit[] getProduits() {
        return produits;
    }


    /**
     * Sets the produits value for this Magasin.
     * 
     * @param produits
     */
    public void setProduits(com.infotel.wssoap.Produit[] produits) {
        this.produits = produits;
    }

    public com.infotel.wssoap.Produit getProduits(int i) {
        return this.produits[i];
    }

    public void setProduits(int i, com.infotel.wssoap.Produit _value) {
        this.produits[i] = _value;
    }
    ...
    static {
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("", "produits"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://wssoap.infotel.com/", "produit"));
        elemField.setMinOccurs(0);
